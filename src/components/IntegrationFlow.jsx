    ...
    return (
        <>
            ...
            <div className="mt-16 sm:mt-20 max-w-7xl mx-auto">
                <div className="text-base font-medium text-blue-600 tracking-wide bg-blue-100 flex justify-self-center py-1 px-6 rounded-3xl max-sm:px-5 max-sm:text-sm max-sm:mb-6 w-max">Integrate</div>
