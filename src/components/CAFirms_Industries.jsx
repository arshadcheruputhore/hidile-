...
const CAFirms_Industries = () => {
    const features = [
        {
            icon: <Workflow className="lg:w-7 lg:h-7 w-5 h-5 text-blue-500" />,
        ...
        {
            icon: <PieChart className="lg:w-7 lg:h-7 w-5 h-5 text-blue-500" />,
            ...
            <div className="max-w-7xl mx-auto max-sm:px-2">
                ...
                <div className="text-center mb-8 lg:mb-12">
                    ...
                    <p className="text-gray-600 text-sm sm:text-base w-full text-left mx-auto leading-relaxed">
                        Hidile automates repetitive tasks and reminders, freeing the accounting teams to go deeper with insights for their clients. Centrally located data, in a secure manner, reduces manual errors and keeps documentation instantly accessible. Real-time updates offer immediate visibility into compliance checks and deadlines. With organized processes, firms can deliver more accurate reporting and build stronger trust with clients.
                    </p>
                </div>
                    ...
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            <div className="absolute lg:-top-8 lg:-left-6 -top-6 -left-3 p-1 bg-blue-50 rounded-full z-20 border border-blue-400/0 group-hover:border-blue-400/100 transition-colors duration-300">
                                <div className="lg:w-12 lg:h-12 w-10 h-10 rounded-full flex items-center justify-center drop-shadow-2xl drop-shadow-blue-50">
                                    {feature.icon}
                                </div>
                            </div>
